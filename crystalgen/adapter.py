...
from crystalgen.denoiser import GemNetTDenoiser, get_chemgraph_from_denoiser_output
...
class GemNetTAdapter(GemNetTDenoiser):
    """
    Denoiser layerwise adapter with GemNetT. On top of a crystalgen.denoiser.GemNetTDenoiser,
