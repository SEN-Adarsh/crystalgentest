...
class CrystalGenCheckpointInfo:
    model_path: str
    ...
    def from_hf_hub(
        ...
        """
        Instantiate a CrystalGenCheckpointInfo object from a model hosted on the Hugging Face Hub.
    ...
    @classmethod
    def from_dict(cls, d) -> "CrystalGenCheckpointInfo":
        d = d.copy()
