...
from crystalgen.common.data.types import PropertySourceId, TargetProperty
from crystalgen.common.utils.data_utils import get_atomic_number
from crystalgen.common.utils.globals import MAX_ATOMIC_NUM, PROPERTY_SOURCE_IDS
...
class SetUnconditionalEmbeddingType:
    ...
    in crystalgen.property_embeddings.PropertyEmbedding.forward.
